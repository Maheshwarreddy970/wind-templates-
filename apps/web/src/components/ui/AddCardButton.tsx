...
const AddCardButton = ({word}:props) => {
  return (
    <button className="group relative text-sm tracking-tight rounded-lg border-2 border-gray-800 bg-gray-800 px-3 py-1 font-medium text-white duration-1000 hover:shadow-lg hover:shadow-gray-900/50">
