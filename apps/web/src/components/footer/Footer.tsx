...
export default function Footer() {
  return (
    <div className=' mt-44'>
    <footer className='w-full mb-12 flex justify-between h-40 py-12 pb-8 px-24 bottom-0 border-t-1 border-black shadow-inner'>
      <div className=''>
        ...
        <div className='my-3'>
        <span className="block ml-1 text-black opacity-80">Wind Templates &copy; 2023</span>
        </div>
      ...
      <div className='flex flex-col gap-2'>
        ...
        <div>
      <span >Website and Templates Build by <Link href='https://twitter.com/Maheshw65793810' className='hover:text-blue-700 text-sm opacity-95'>@maheshwarreddy</Link></span>
        </div>
      </div>
    </footer>
    </div>
